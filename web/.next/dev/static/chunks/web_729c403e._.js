...
function CategoriesCarousel(t0) {
    ...
    if ($[0] !== "951d42d75d8c6381970e9ab6a3d8e36de0714e92e14334bd32677d9ae76fd14b") {
        for(let $i = 0; $i < 41; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "951d42d75d8c6381970e9ab6a3d8e36de0714e92e14334bd32677d9ae76fd14b";
    }
...
"[project]/web/src/components/ui/HomeBannerCarousel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function HomeBannerCarousel(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(30);
    if ($[0] !== "3a3bb2cbdacf3b115650694a558703665fd7fe19d30d82c1a7a25c32c219289c") {
        for(let $i = 0; $i < 30; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3a3bb2cbdacf3b115650694a558703665fd7fe19d30d82c1a7a25c32c219289c";
    }
    const { banners, autoPlayMs: t1 } = t0;
    const autoPlayMs = t1 === undefined ? 3000 : t1;
    const { language, isRTL } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$components$2f$providers$2f$StorefrontProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStorefront"])();
    const [activeIndex, setActiveIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    let t2;
    let t3;
    if ($[1] !== autoPlayMs || $[2] !== banners.length) {
        t2 = ({
            "HomeBannerCarousel[useEffect()]": ()=>{
                if (banners.length <= 1) {
                    return;
                }
                const intervalId = window.setInterval({
                    "HomeBannerCarousel[useEffect() > window.setInterval()]": ()=>{
                        setActiveIndex({
                            "HomeBannerCarousel[useEffect() > window.setInterval() > setActiveIndex()]": (currentIndex)=>(currentIndex + 1) % banners.length
                        }["HomeBannerCarousel[useEffect() > window.setInterval() > setActiveIndex()]"]);
                    }
                }["HomeBannerCarousel[useEffect() > window.setInterval()]"], autoPlayMs);
                return ()=>{
    ...
    const currentIndex_0 = activeIndex < banners.length ? activeIndex : 0;
    const activeBanner = banners[currentIndex_0];
    let t4;
    if ($[5] !== activeBanner.link) {
        t4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$storefront$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveBannerHref"])(activeBanner.link);
        $[5] = activeBanner.link;
        $[6] = t4;
    } else {
        t4 = $[6];
    }
    const activeBannerHref = t4;
    ...
    if ($[7] !== banners.length) {
        t5 = ({
            "HomeBannerCarousel[goNext]": ()=>{
                setActiveIndex({
                    "HomeBannerCarousel[goNext > setActiveIndex()]": (currentIndex_1)=>(currentIndex_1 + 1) % banners.length
                }["HomeBannerCarousel[goNext > setActiveIndex()]"]);
            }
        })["HomeBannerCarousel[goNext]"];
        $[7] = banners.length;
        $[8] = t5;
    ...
    if ($[9] !== banners.length) {
        t6 = ({
            "HomeBannerCarousel[goPrev]": ()=>{
                setActiveIndex({
                    "HomeBannerCarousel[goPrev > setActiveIndex()]": (currentIndex_2)=>(currentIndex_2 - 1 + banners.length) % banners.length
                }["HomeBannerCarousel[goPrev > setActiveIndex()]"]);
            }
        })["HomeBannerCarousel[goPrev]"];
        $[9] = banners.length;
        $[10] = t6;
    ...
    const handleLeftClick = isRTL ? goNext : goPrev;
    const handleRightClick = isRTL ? goPrev : goNext;
    const t7 = activeBanner.title || fallbackAlt;
    const t8 = currentIndex_0 === 0 ? "eager" : "lazy";
    let t9;
    if ($[11] !== activeBanner.image_url || $[12] !== t7 || $[13] !== t8) {
        t9 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
    ...
    let t11;
    if ($[18] !== activeBanner.title || $[19] !== banners.length || $[20] !== currentIndex_0 || $[21] !== fallbackTitle || $[22] !== handleLeftClick || $[23] !== handleRightClick || $[24] !== nextLabel || $[25] !== previousLabel) {
        t11 = banners.length > 1 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HomeBannerCarousel, "QPkolmGaRi80apHe5Epx/5Pd1zw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$components$2f$providers$2f$StorefrontProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStorefront"]
    ];
});
_c = HomeBannerCarousel;
var _c;
__turbopack_context__.k.register(_c, "HomeBannerCarousel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=web_729c403e._.js.map